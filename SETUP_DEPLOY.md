...
## 4단계 — GitHub Pages 켜기 (브랜치 배포)

1. 저장소 페이지 → **Settings** → 왼쪽 **Pages**
2. **Build and deployment → Source**: **Deploy from a branch** 선택
3. **Branch**: `main` / 폴더: **/(root)** 선택 후 **Save**
4. 1~2분 뒤 `https://shanks-blip.github.io/ai-guide/` 에서 공개됩니다.

> 참고: 토큰에 Contents 권한만 부여했기 때문에 워크플로(.github) 대신 **브랜치 배포** 방식을 씁니다. 추가 권한이 필요 없어 더 간단합니다.

...
(function () {
  ...
  window.AI_NAV_SECTIONS = {"start":[{"id":"what","text":"생성형 AI란 무엇인가요?"},{"id":"can","text":"무엇을 할 수 있나요?"},{"id":"how","text":"어떻게 작동하나요?"},{"id":"signup","text":"가입하고 접속하기"},{"id":"first","text":"첫 대화 5분 따라하기"},{"id":"improve","text":"결과를 좋게 만드는 작은 습관"},{"id":"settings","text":"알아두면 좋은 기본 설정"},{"id":"caution","text":"안전하게 쓰기"},{"id":"tools","text":"다른 AI 도구들"},{"id":"verify","text":"AI 답 검증·저작권"},{"id":"ethics","text":"AI 편향·윤리"},{"id":"privacy","text":"내 정보 지키기"},{"id":"community","text":"계속 배우기·커뮤니티"},{"id":"work-pc","text":"회사 PC에서 AI 쓰기"},{"id":"next","text":"다음 단계"}],"prompting":[{"id":"why","text":"왜 프롬프트가 중요한가"},{"id":"anatomy","text":"프롬프트 해부도 — 5요소"},{"id":"principles","text":"좋은 프롬프트 7원칙"},{"id":"advanced","text":"한 단계 위 기법"},{"id":"templates","text":"복사용 템플릿 모음"},{"id":"mistakes","text":"흔한 실수 & 체크리스트"},{"id":"next","text":"다음 단계로"}],"claude":[{"id":"diff","text":"한눈에 보는 차이"},{"id":"basic","text":"기초 — Claude 챗 시작하기 입문"},{"id":"features","text":"꼭 쓰는 핵심 기능"},{"id":"cowork","text":"Claude Cowork 시작하기 중급"},{"id":"cowork-use","text":"Cowork 실전 예시 중급"},{"id":"adv","text":"심화 — API · Claude Code · MCP 고급"},{"id":"faq","text":"자주 묻는 질문"},{"id":"video","text":"영상으로 배우기"},{"id":"links","text":"추천 자료 (전부 접속 확인)"}],"chatgpt":[{"id":"basic","text":"기초 — ChatGPT 시작하기 입문"},{"id":"features","text":"핵심 기능 깊이 보기"},{"id":"price","text":"요금제 한눈에 ChatGPT"},{"id":"usage","text":"실전 활용 예시 활용"},{"id":"codex","text":"Codex — 코딩 에이전트 중급"},{"id":"adv","text":"심화 — API · Function Calling 고급"},{"id":"faq","text":"자주 묻는 질문"},{"id":"video","text":"영상으로 배우기"},{"id":"links","text":"추천 자료 (전부 접속 확인)"}],"usecases":[{"id":"docs","text":"1. 기획·문서 쓰기"},{"id":"comms","text":"2. 마케팅·고객 커뮤니케이션"},{"id":"dev","text":"3. 개발"},{"id":"data","text":"4. 데이터·분석"},{"id":"automation","text":"5. 자동화·에이전트 활용"},{"id":"excel","text":"6. 스프레드시트·Excel 심화"},{"id":"imagegen","text":"7. AI 이미지 생성"},{"id":"research","text":"8. 리서치·Deep Research"},{"id":"design","text":"9. 디자인·크리에이티브"},{"id":"learn","text":"10. 교육·학습"},{"id":"voice","text":"11. 음성·오디오 AI"},{"id":"vision","text":"12. 비전·이미지 읽기"},{"id":"videogen","text":"13. AI 영상 생성"},{"id":"backoffice","text":"14. 법무·인사·재무"},{"id":"meetings","text":"15. 회의 녹음→회의록"},{"id":"personal","text":"16. 나만의 AI 작업공간"},{"id":"translate","text":"17. AI 번역·현지화"},{"id":"cs","text":"18. 고객 문의 응대"},{"id":"grounding","text":"19. 문서 기반 AI로 환각 줄이기"},{"id":"claude-workspace","text":"20. 문서·슬라이드 (Docs·Slides)"}],"advanced":[{"id":"ladder","text":"활용 사다리","cat":"개요"},{"id":"overview","text":"개발 공통 준비","cat":"개요"},{"id":"api","text":"API 첫 호출","cat":"연결·연동"},{"id":"api-deep","text":"API 심화","cat":"연결·연동"},{"id":"mcp","text":"MCP 쓰기","cat":"연결·연동"},{"id":"mcp-build","text":"MCP 서버 만들기","cat":"연결·연동"},{"id":"function","text":"함수 호출","cat":"연결·연동"},{"id":"tool-scale","text":"도구가 많아질 때","cat":"연결·연동"},{"id":"connectors","text":"커넥터·확장","cat":"연결·연동"},{"id":"acp","text":"에디터에 에이전트 꽂기","cat":"연결·연동"},{"id":"auto","text":"자동화·예약","cat":"자동화·에이전트"},{"id":"agent-schedule","text":"에이전트 정기 실행","cat":"자동화·에이전트"},{"id":"headless-ci","text":"헤드리스·CI 실행","cat":"자동화·에이전트"},{"id":"nocode","text":"노코드 자동화","cat":"자동화·에이전트"},{"id":"agent","text":"에이전트 개념","cat":"자동화·에이전트"},{"id":"agents","text":"에이전트 엔지니어링","cat":"자동화·에이전트"},{"id":"agent-runtime","text":"에이전트 런타임 빌려쓰기","cat":"자동화·에이전트"},{"id":"subagents","text":"서브에이전트","cat":"자동화·에이전트"},{"id":"agent-teams","text":"에이전트 팀","cat":"자동화·에이전트"},{"id":"dynamic-workflows","text":"동적 워크플로","cat":"자동화·에이전트"},{"id":"multiagent","text":"멀티에이전트 오케스트레이션","cat":"자동화·에이전트"},{"id":"agent-comms","text":"에이전트 간 실시간 소통","cat":"자동화·에이전트"},{"id":"agent-ops","text":"에이전트 운영","cat":"자동화·에이전트"},{"id":"loop-eng","text":"루프 엔지니어링","cat":"자동화·에이전트"},{"id":"parallel-worktrees","text":"병렬 워크트리","cat":"자동화·에이전트"},{"id":"context-eng","text":"컨텍스트 엔지니어링","cat":"구축·데이터"},{"id":"rag","text":"RAG 구현","cat":"구축·데이터"},{"id":"evals","text":"평가·Evals","cat":"구축·데이터"},{"id":"tdd","text":"테스트 주도(TDD)","cat":"구축·데이터"},{"id":"test-audit","text":"테스트 감사자","cat":"구축·데이터"},{"id":"code-map","text":"코드베이스 색인·코드맵","cat":"구축·데이터"},{"id":"memory","text":"메모리·컨텍스트 편집","cat":"구축·데이터"},{"id":"compaction","text":"대화 압축(compaction)","cat":"구축·데이터"},{"id":"structured-output","text":"구조화된 출력","cat":"구축·데이터"},{"id":"voice-agents","text":"음성 에이전트","cat":"구축·데이터"},{"id":"spec-driven","text":"스펙 주도 개발","cat":"구축·데이터"},{"id":"frameworks","text":"프레임워크 선택","cat":"구축·데이터"},{"id":"local","text":"로컬·파인튜닝","cat":"구축·데이터"},{"id":"security","text":"AI 앱 보안","cat":"운영·보안"},{"id":"sec-testing","text":"보안 레드팀·시험","cat":"운영·보안"},{"id":"supply-chain","text":"확장 공급망 보안","cat":"운영·보안"},{"id":"permission-modes","text":"권한 모드·자동 모드","cat":"운영·보안"},{"id":"sandbox","text":"샌드박스·격리","cat":"운영·보안"},{"id":"llmops","text":"프로덕션·LLMOps","cat":"운영·보안"},{"id":"observability","text":"실행 추적·관찰가능성","cat":"운영·보안"},{"id":"cost-opt","text":"비용 최적화","cat":"운영·보안"},{"id":"models","text":"모델 선택","cat":"운영·보안"},{"id":"gateway","text":"AI 게이트웨이·멀티모델","cat":"운영·보안"},{"id":"cc-skills","text":"Claude Code 스킬","cat":"도구별 실전"},{"id":"skills-build","text":"스킬 설계·제작","cat":"도구별 실전"},{"id":"cc-plugins","text":"Claude Code 플러그인","cat":"도구별 실전"},{"id":"codex-goal","text":"Codex goal","cat":"도구별 실전"},{"id":"vibe-launch","text":"바이브코딩 런칭","cat":"도구별 실전"},{"id":"harness","text":"하네스 엔지니어링","cat":"도구별 실전"},{"id":"harness-tuning","text":"하네스 부품 고르기","cat":"도구별 실전"},{"id":"plan-first","text":"플랜 모드","cat":"도구별 실전"},{"id":"ai-env","text":"AI 환경 만들기","cat":"도구별 실전"},{"id":"agents-md","text":"AGENTS.md","cat":"도구별 실전"},{"id":"plugin-eval","text":"플러그인 자동 채점(eval)","cat":"도구별 실전"},{"id":"cc-hooks","text":"훅 자동화","cat":"도구별 실전"},{"id":"slash-commands","text":"커스텀 슬래시 명령","cat":"도구별 실전"},{"id":"code-review","text":"AI 코드 리뷰 자동화","cat":"도구별 실전"},{"id":"codex-cross","text":"Codex 교차 검증","cat":"도구별 실전"},{"id":"codex-subagents","text":"Codex 서브에이전트","cat":"도구별 실전"},{"id":"cc-browser","text":"인앱 브라우저","cat":"도구별 실전"},{"id":"debug","text":"에이전트 디버깅","cat":"도구별 실전"},{"id":"rewind","text":"실수 되돌리기","cat":"도구별 실전"},{"id":"shorts-pipeline","text":"쇼츠 자동 제작","cat":"도구별 실전"},{"id":"agent-model-swap","text":"에이전트에 모델 물리기","cat":"도구별 실전"},{"id":"links","text":"더 배울 자료","cat":"자료"}]};
  const ICONS = {

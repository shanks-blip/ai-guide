...
cd "$WORK/repo"
rm -rf scripts; rm -f CHANGELOG_auto.md OPS_BACKLOG.md; rm -f resources.html SESSION_NOTES.md SITE_ROADMAP.md CONTENT_MAP.md 사이트_평가_및_개발자_보완_로드맵.md PLAN_self_operating_v2.md DESIGN_v2.md LEGAL_AUDIT.md MIGRATION_CLOUDFLARE.md
